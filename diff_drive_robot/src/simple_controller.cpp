#include "diff_drive_robot/simple_controller.hpp"
                                  ...
                                  , theta_(0.0)
{
    ...
    vel_sub_ = create_subscription<geometry_msgs::msg::TwistStamped>("/diff_drive_robot_controller/cmd_vel", 10, std::bind(&SimpleController::velCallback, this, _1));
    ...
    odom_pub_ = create_publisher<nav_msgs::msg::Odometry>("/diff_drive_robot_controller/odom", 10);
